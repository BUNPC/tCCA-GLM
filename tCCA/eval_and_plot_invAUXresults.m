...
% ##### FOLLOWING TWO LINES NEED CHANGE ACCORDING TO USER!
    path.auxres20 = 'CV_AUX_contributions_20'; % save directory
    path.auxres50 = 'CV_AUX_contributions_50'; % save directory
    path.auxres100 = 'CV_AUX_contributions_100'; % save directory
    path.auxres20stmse = 'CV_AUX_contributions_20_stMSE'; % save directory
    path.auxres50stmse = 'CV_AUX_contributions_50_stMSE'; % save directory
    path.auxres100stmse = 'CV_AUX_contributions_100_stMSE'; % save directory
    path.savefig = 'Fig 10 AUX contribution Matrix';
% if melexflag
%     %Meryem
